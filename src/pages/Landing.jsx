...
const Landing = () => {
  ...
  const now = new Date();
  // Chỉnh múi giờ và định dạng về: YYYY-MM-DDTHH:mm
  ...
  const banners = [
    {
      ...
      description:
        "Giảm 500.000đ cho 50 học viên đầu tiên đăng ký trong tháng này",
      button: {
        label: "Đăng ký ngay",
    ...
    <PortalLayout>
      <div className="pb-16 pt-2">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
              Trung tâm đào tạo lái xe minh bạch,{" "}
              <span className="text-indigo-600">dễ theo dõi</span> từ đăng ký
              đến sát hạch
            </h1>
            <p className="text-lg text-slate-600">
              Công khai học phí, lịch khai giảng, tiến độ hồ sơ. Học viên và
              nhân viên cùng theo dõi một nguồn thông tin duy nhất.
            </p>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              />
              <StatCard
                title="Tỷ lệ thi đậu lý thuyết"
                value="92%"
                delta="Thi thử không giới hạn"
              />
              <StatCard
                title="Lịch trống tuần này"
                value="38 slot"
                delta="Thực hành + lý thuyết"
              />
            </div>
          </div>
        ...
        <div className="mt-14 rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-8 shadow-sm text-center">
          <p className="text-xs font-semibold uppercase text-indigo-500 tracking-wider mb-2">
            Khóa học & Học phí
          </p>
          ...
          <p className="text-slate-500 mb-6 text-sm max-w-md mx-auto">
            Xem đầy đủ các khóa học, chi tiết học phí từng đợt và lịch khai
            giảng mới nhất của trung tâm.
          </p>
          <Link
            to="/courses"
          ...
          <div className="relative grid gap-10 md:grid-cols-2 lg:gap-16 items-center p-8 md:p-12 lg:p-16">
            ...
            <div className="text-white space-y-6">
              <h2 className="text-3xl font-bold sm:text-4xl text-white leading-tight">
                Dạy lái bằng cả trái tim!
                <br />
                <span className="text-yellow-400 text-5xl mt-2 block">
                  Tự tin vững lái
                </span>
              </h2>
              <div className="w-16 h-1 bg-yellow-400 rounded-full" />
              <p className="text-lg text-white/90 leading-relaxed font-medium">
                Đào tạo học lái xe ô tô Uy Tín và Chất Lượng 100% luôn đi đầu
                trong khu vực và trong cả nước.
              </p>
              <p className="text-white/80">
                Với chi phí hợp lí, bạn đã có thể học lái xe ô tô một cách thuần
                thục.
              </p>
            ...
            <div className="rounded-3xl bg-white/95 p-6 shadow-xl backdrop-blur-sm sm:p-8">
              <div className="mb-6 border-b border-slate-100 pb-6 text-center">
                ...
                <h3 className="mt-2 text-2xl font-black uppercase text-slate-900 leading-tight">
                  <span className="text-indigo-600">Khuyến mãi toàn quốc</span>
                  <br />
                  <span className="text-red-500 text-lg">
                    Giảm ngay 20% học phí
                  </span>
                </h3>
                <p className="mt-3 text-sm text-slate-600 flex justify-center items-center gap-1">
                  <span className="text-orange-500">🔥</span> Chỉ còn 5 suất ưu
                  đãi cuối cùng
                </p>
              </div>
